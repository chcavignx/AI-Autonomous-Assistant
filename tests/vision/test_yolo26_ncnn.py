"""Unit tests for Yolo26NcnnDetector."""
...
import numpy as np
import pytest
from src.vision.base import BaseDetector, Detection
...
def test_yolo26_ncnn_detector_init(mock_yolo: MagicMock) -> None:
...
@patch("src.vision.yolo_cpu.YOLO")
def test_yolo26_ncnn_detector_infer_no_results(mock_yolo: MagicMock) -> None:
...
@patch("src.vision.yolo_cpu.YOLO")
def test_yolo26_ncnn_detector_infer_with_results(mock_yolo: MagicMock) -> None:
...
@patch("src.vision.yolo_cpu.YOLO")
def test_yolo26_ncnn_detector_detect(mock_yolo: MagicMock) -> None:
...
def test_yolo26_ncnn_detector_draw_detections() -> None:
...
@patch("src.vision.yolo_cpu.YOLO")
def test_yolo26_ncnn_detector_stop(mock_yolo: MagicMock) -> None:
